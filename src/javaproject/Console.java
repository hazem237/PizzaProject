...
public class Console {
    ...
    public static void clearOrder() {
        //the method will clear the ArrayList after making the pizza
    ...
    public static void chooseFromStartMenu() throws SoldOut, Exception {
        //this method is to ask the user if he want to order, if not will close the program
        while (choice != 2) {
            clrscr();
            displayStartMenu();
    ...
    public static void chooseFromPizzaTypeMenu() throws SoldOut, Exception {
        //this method is to make user choose the pizza type
        choice = input.nextInt();
        switch (choice) {
            case 1:
    ...
    public static void chooseFromSizeMenu() throws SoldOut, Exception {
        //this method is to make the user choose the size of pizza
        choice = input.nextInt();
        switch (choice) {
            case 1:
    ...
    public static void chooseFromSliceMenu() throws SoldOut, Exception {
        //this menu is to make user choose the number of slice he want
        choice = input.nextInt();
        switch (choice) {
            case 1:
                pan.setSlice(4);
    ...
    public static void chooseFromDrinksMenu() throws SoldOut, Exception {
        //this method is to make the user choose if he want a drink or not
        choice = input.nextInt();
        switch (choice) {
            case 1:
    ...
    public static void chooseFromConfirmMenu() throws SoldOut, Exception {
        //this method is to ask the user if he want his pizza after seeing the price and amount of calories, if not, the order will be canceled and the ArrayList will be cleard
        choice = input.nextInt();
        switch (choice) {
            case 1:
                clrscr();
