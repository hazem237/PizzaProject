...
public class Mixer {
    ...
    private String deep;
    Ingredients dough = new Ingredients("dough", 4000);//fill dough storage with 4000 gram
    ...
    public void makeDough() throws SoldOut {
        // when the pizza size and deep choosed this method will specify how much dough will be used
    ...
    public static void cheakDoghStorage(Ingredients i) throws SoldOut {
        //this method is to make sure that the dough in storage is enough to make pizza, if not will throw exception
        MyException.sold(i);
